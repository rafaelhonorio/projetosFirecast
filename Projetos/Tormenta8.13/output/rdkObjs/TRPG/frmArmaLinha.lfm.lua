...
local function constructNew_frmArmaLinha()
...
function newfrmArmaLinha()
    local retObj = nil;
    __o_rrpgObjs.beginObjectsLoading();

    __o_Utils.tryFinally(
      function()
        retObj = constructNew_frmArmaLinha();
      end,
      function()
...
frmArmaLinha = _frmArmaLinha;
Firecast.registrarForm(_frmArmaLinha);

return _frmArmaLinha;
