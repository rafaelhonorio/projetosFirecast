...
local function constructNew_Tormentafrm()
    ...
    obj:setTitle("Ficha Tormenta RPG (Firecast 8.13)");
    obj:setWidth(1010);
    obj:setHeight(730);
    obj:setMinWidth(700);
    ...
    obj.Tormenta01:setWidth(1010);
    obj.Tormenta01:setHeight(700);
    obj.Tormenta01:setMinWidth(700);
    obj.Tormenta01:setMaxWidth(1280);
    ...
    obj.lytCanvas01:setTop(0);
    obj.lytCanvas01:setWidth(1010);
    obj.lytCanvas01:setHeight(700);
    obj.lytCanvas01:setMargins({left=0,top=0,right=0,bottom=0});

    obj.rectangle1 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle1:setParent(obj.lytCanvas01);
    ...
    obj.image1:setParent(obj.lytCanvas01);
    ...
    obj.layout1:setParent(obj.lytCanvas01);
    ...
    obj.layout2:setParent(obj.lytCanvas01);
    ...
    obj.layout3:setParent(obj.lytCanvas01);
    ...
    obj.layout4:setParent(obj.lytCanvas01);
    ...
    obj.layout5:setParent(obj.lytCanvas01);
    ...
    obj.layout6:setParent(obj.lytCanvas01);
    ...
    obj.layout7:setParent(obj.lytCanvas01);
    ...
    obj.layout8:setParent(obj.lytCanvas01);
    ...
    obj.layout9:setParent(obj.lytCanvas01);
    ...
    obj.button4:setTextTrimming("none");
    ...
    obj.button5:setTextTrimming("none");
    ...
    obj.button6:setTextTrimming("none");

    obj.layout16 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout16:setParent(obj.lytCanvas01);
    ...
    obj.button7:setTextTrimming("none");
    ...
    obj.button8:setTextTrimming("none");
    ...
    obj.layout28:setParent(obj.lytCanvas01);
    ...
    obj.button9:setTextTrimming("none");
    ...
    obj.button10:setTextTrimming("none");
    ...
    obj.layout29:setParent(obj.lytCanvas01);
    ...
    obj.button11:setTextTrimming("none");
    ...
    obj.button12:setTextTrimming("none");
    ...
    obj.layout30:setParent(obj.lytCanvas01);
    ...
    obj.button13:setTextTrimming("none");
    ...
    obj.button14:setTextTrimming("none");
    ...
    obj.layout31:setParent(obj.lytCanvas01);
    ...
    obj.layout32:setParent(obj.lytCanvas01);
    ...
    obj.layout33:setParent(obj.lytCanvas01);
    ...
    obj.rectangle55:setParent(obj.lytCanvas01);
    ...
    obj.label58:setParent(obj.lytCanvas01);
    ...
    obj.rectangle56:setParent(obj.lytCanvas01);
    ...
    obj.rectangle57:setParent(obj.lytCanvas01);
    ...
    obj.image2:setParent(obj.lytCanvas01);
    ...
    obj.layout34:setParent(obj.lytCanvas01);
    ...
    obj.button15:setTextTrimming("none");
    ...
    obj.button16:setTextTrimming("none");
    ...
    obj.layout36:setParent(obj.lytCanvas01);
    ...
    obj.button17:setTextTrimming("none");
    ...
    obj.button18:setTextTrimming("none");
    ...
    obj.layout38:setParent(obj.lytCanvas01);
    ...
    obj.layout39:setParent(obj.lytCanvas01);
    ...
    obj.layout40:setParent(obj.lytCanvas01);
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
        ...
        if TRPG_updateScale == nil then
			...
			-- equipado  = n.equipado (checkbox)

			function TRPG_calcDefesasCA(sheet)
				local armadura = 0
				local escudo   = 0
				local outros   = 0
				local capDex   = nil -- menor bônus máximo de DES entre armaduras EQUIPADAS

				for _, n in ipairs(getChildNodesSafe(sheet.listaDefesas)) do
					-- ✅ só considera se estiver equipado
					-- (se n.equipado for nil, tratamos como true pra não quebrar fichas antigas)
					local equipado = (n.equipado == nil) or (n.equipado == true)
					if equipado then
						...
						if cat == "armadura" then
							...
							-- capDex só vale para armaduras equipadas
							if bmDex ~= nil then
								bmDex = math.floor(bmDex)

								-- regra que você já usava:
								-- se estiver vazio/0/negativo => ignora (sem limite)
								if bmDex > 0 then
    ...
    obj.Tormenta02:setWidth(1010);
    obj.Tormenta02:setHeight(700);
    obj.Tormenta02:setMinWidth(700);
    obj.Tormenta02:setMaxWidth(1280);
    ...
    obj.lytCanvas02:setTop(0);
    obj.lytCanvas02:setWidth(1010);
    obj.lytCanvas02:setHeight(700);
    obj.lytCanvas02:setMargins({left=0,top=0,right=0,bottom=0});

    obj.rectangle88 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle88:setParent(obj.lytCanvas02);
    obj.rectangle88:setWidth(1010);
    obj.rectangle88:setHeight(700);
    obj.rectangle88:setColor("LightGray");
    obj.rectangle88:setXradius(10);
    obj.rectangle88:setYradius(10);
    obj.rectangle88:setName("rectangle88");

    obj.layout41 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout41:setParent(obj.lytCanvas02);
    obj.layout41:setLeft(3);
    obj.layout41:setTop(1);
    obj.layout41:setWidth(480);
    obj.layout41:setHeight(700);
    obj.layout41:setName("layout41");

    obj.rectangle89 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle89:setParent(obj.layout41);
    obj.rectangle89:setLeft(249);
    ...
    obj.label83:setLeft(256);
    obj.label83:setTop(2);
    ...
    obj.rectangle90:setParent(obj.layout41);
    obj.rectangle90:setLeft(308);
    obj.rectangle90:setTop(1);
    obj.rectangle90:setColor("Black");
    obj.rectangle90:setWidth(38);
    ...
    obj.label84:setText("Grad");
    obj.label84:setName("label84");
    obj.label84:setTextTrimming("none");

    obj.rectangle91 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle91:setParent(obj.layout41);
    obj.rectangle91:setLeft(374);
    obj.rectangle91:setTop(1);
    obj.rectangle91:setColor("Black");
    obj.rectangle91:setWidth(38);
    ...
    obj.label86:setLeft(443);
    obj.label86:setTop(2);
    obj.label86:setWidth(48);
    obj.label86:setHeight(8);
    ...
    obj.imageCheckBox1:setParent(obj.layout43);
    ...
    obj.button21:setHint("Rolar 1d20 + Acrobacia");
    obj.button21:setName("button21");
    obj.button21:setTextTrimming("none");

    obj.totalacrobacia = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalacrobacia:setParent(obj.layout43);
    ...
    obj.rectangle94:setParent(obj.layout43);
    ...
    obj.gradacrobacia:setParent(obj.layout43);
    ...
    obj.rectangle95:setParent(obj.layout43);
    ...
    obj.modacrobacia:setParent(obj.layout43);
    ...
    obj.rectangle96:setParent(obj.layout43);
    ...
    obj.label90:setParent(obj.layout43);
    obj.label90:setLeft(419);
    ...
    obj.outrosacrobacia:setParent(obj.layout43);
    ...
    obj.imageCheckBox2:setParent(obj.layout44);
    ...
    obj.button22:setParent(obj.layout44);
    ...
    obj.button22:setTextTrimming("none");

    obj.label91 = GUI.fromHandle(_obj_newObject("label"));
    obj.label91:setParent(obj.layout44);
    obj.label91:setLeft(50);
    obj.label91:setTop(5);
    obj.label91:setWidth(150);
    obj.label91:setHeight(20);
    obj.label91:setText("Adestrar Animais ❄");
    obj.label91:setHorzTextAlign("leading");
    obj.label91:setFontSize(15.0);
    ...
    obj.button23:setParent(obj.layout44);
    ...
    obj.button23:setHint("Rolar 1d20 + Adestrar Animais");
    obj.button23:setName("button23");
    obj.button23:setTextTrimming("none");

    obj.totaladestrar = GUI.fromHandle(_obj_newObject("edit"));
    obj.totaladestrar:setParent(obj.layout44);
    ...
    obj.rectangle98:setParent(obj.layout44);
    ...
    obj.label92:setParent(obj.layout44);
    obj.label92:setLeft(292);
    ...
    obj.gradadestrar:setParent(obj.layout44);
    ...
    obj.rectangle99:setParent(obj.layout44);
    ...
    obj.label93:setParent(obj.layout44);
    obj.label93:setLeft(353);
    ...
    obj.modadestrar:setParent(obj.layout44);
    ...
    obj.rectangle100:setParent(obj.layout44);
    ...
    obj.label94:setParent(obj.layout44);
    obj.label94:setLeft(419);
    ...
    obj.outrosadestrar:setParent(obj.layout44);
    ...
    obj.imageCheckBox3:setParent(obj.layout45);
    ...
    obj.button24:setParent(obj.layout45);
    ...
    obj.button25:setParent(obj.layout45);
    ...
    obj.button25:setHint("Rolar 1d20 + Atletismo");
    obj.button25:setName("button25");
    obj.button25:setTextTrimming("none");

    obj.totalatletismo = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalatletismo:setParent(obj.layout45);
    ...
    obj.rectangle102:setParent(obj.layout45);
    ...
    obj.label96:setParent(obj.layout45);
    obj.label96:setLeft(292);
    ...
    obj.gradatletismo:setParent(obj.layout45);
    ...
    obj.rectangle103:setParent(obj.layout45);
    ...
    obj.label97:setParent(obj.layout45);
    obj.label97:setLeft(353);
    ...
    obj.modatletismo:setParent(obj.layout45);
    ...
    obj.rectangle104:setParent(obj.layout45);
    ...
    obj.label98:setParent(obj.layout45);
    obj.label98:setLeft(419);
    ...
    obj.outrosatletismo:setParent(obj.layout45);
    ...
    obj.imageCheckBox4:setParent(obj.layout46);
    ...
    obj.button26:setParent(obj.layout46);
    ...
    obj.button27:setParent(obj.layout46);
    ...
    obj.button27:setTextTrimming("none");
    ...
    obj.totalatuacao1:setParent(obj.layout46);
    ...
    obj.rectangle106:setParent(obj.layout46);
    ...
    obj.label100:setParent(obj.layout46);
    obj.label100:setLeft(292);
    ...
    obj.gradatuacao1:setParent(obj.layout46);
    ...
    obj.rectangle107:setParent(obj.layout46);
    ...
    obj.label101:setParent(obj.layout46);
    obj.label101:setLeft(353);
    ...
    obj.modatuacao1:setParent(obj.layout46);
    ...
    obj.rectangle108:setParent(obj.layout46);
    ...
    obj.label102:setParent(obj.layout46);
    obj.label102:setLeft(419);
    ...
    obj.outrosatuacao1:setParent(obj.layout46);
    ...
    obj.imageCheckBox5:setParent(obj.layout47);
    ...
    obj.button28:setParent(obj.layout47);
    ...
    obj.button29:setParent(obj.layout47);
    ...
    obj.button29:setHint("Rolar 1d20 + Atuação");
    obj.button29:setName("button29");
    obj.button29:setTextTrimming("none");

    obj.edit56 = GUI.fromHandle(_obj_newObject("edit"));
    obj.edit56:setParent(obj.layout47);
    ...
    obj.totalatuacao2:setParent(obj.layout47);
    ...
    obj.label104:setParent(obj.layout47);
    obj.label104:setLeft(292);
    ...
    obj.gradatuacao2:setParent(obj.layout47);
    ...
    obj.rectangle111:setParent(obj.layout47);
    ...
    obj.label105:setParent(obj.layout47);
    obj.label105:setLeft(353);
    ...
    obj.modatuacao2:setParent(obj.layout47);
    ...
    obj.rectangle112:setParent(obj.layout47);
    ...
    obj.label106:setParent(obj.layout47);
    obj.label106:setLeft(419);
    ...
    obj.outrosatuacao2:setParent(obj.layout47);
    ...
    obj.imageCheckBox6:setParent(obj.layout48);
    ...
    obj.button30:setParent(obj.layout48);
    ...
    obj.gradcavalgar:setParent(obj.layout48);
    ...
    obj.modcavalgar:setParent(obj.layout48);
    ...
    obj.rectangle116:setParent(obj.layout48);
    ...
    obj.outroscavalgar:setParent(obj.layout48);
    ...
    obj.imageCheckBox7:setParent(obj.layout49);
    ...
    obj.button32:setTextTrimming("none");

    obj.label111 = GUI.fromHandle(_obj_newObject("label"));
    obj.label111:setParent(obj.layout49);
    obj.label111:setLeft(50);
    obj.label111:setTop(5);
    obj.label111:setWidth(150);
    obj.label111:setHeight(20);
    obj.label111:setText("Conhecimento ❄");
    ...
    obj.button33:setTextTrimming("none");
    ...
    obj.totalconhecimento1:setParent(obj.layout49);
    ...
    obj.rectangle118:setParent(obj.layout49);
    ...
    obj.gradconhecimento1:setParent(obj.layout49);
    ...
    obj.rectangle119:setParent(obj.layout49);
    ...
    obj.modconhecimento1:setParent(obj.layout49);
    ...
    obj.rectangle120:setParent(obj.layout49);
    ...
    obj.outrosconhecimento1:setParent(obj.layout49);
    ...
    obj.imageCheckBox8:setParent(obj.layout50);
    ...
    obj.button34:setTextTrimming("none");

    obj.label115 = GUI.fromHandle(_obj_newObject("label"));
    obj.label115:setParent(obj.layout50);
    obj.label115:setLeft(50);
    obj.label115:setTop(5);
    obj.label115:setWidth(150);
    obj.label115:setHeight(20);
    obj.label115:setText("Conhecimento ❄");
    obj.label115:setHorzTextAlign("leading");
    obj.label115:setFontSize(15.0);
    ...
    obj.button35:setParent(obj.layout50);
    ...
    obj.button35:setHint("Rolar 1d20 + Conhecimento");
    obj.button35:setName("button35");
    obj.button35:setTextTrimming("none");
    ...
    obj.totalconhecimento2:setParent(obj.layout50);
    ...
    obj.rectangle122:setParent(obj.layout50);
    ...
    obj.gradconhecimento2:setParent(obj.layout50);
    ...
    obj.rectangle123:setParent(obj.layout50);
    ...
    obj.modconhecimento2:setParent(obj.layout50);
    ...
    obj.rectangle124:setParent(obj.layout50);
    ...
    obj.outrosconhecimento2:setParent(obj.layout50);
    ...
    obj.imageCheckBox9:setParent(obj.layout51);
    ...
    obj.button36:setParent(obj.layout51);
    ...
    obj.button37:setParent(obj.layout51);
    ...
    obj.button37:setHint("Rolar 1d20 + Cura");
    obj.button37:setName("button37");
    obj.button37:setTextTrimming("none");

    obj.totalcura = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalcura:setParent(obj.layout51);
    ...
    obj.rectangle126:setParent(obj.layout51);
    ...
    obj.label120:setParent(obj.layout51);
    obj.label120:setLeft(292);
    ...
    obj.gradcura:setParent(obj.layout51);
    ...
    obj.rectangle127:setParent(obj.layout51);
    ...
    obj.label121:setParent(obj.layout51);
    obj.label121:setLeft(353);
    ...
    obj.modcura:setParent(obj.layout51);
    ...
    obj.rectangle128:setParent(obj.layout51);
    ...
    obj.outroscura:setParent(obj.layout51);
    ...
    obj.imageCheckBox10:setParent(obj.layout52);
    ...
    obj.button38:setParent(obj.layout52);
    ...
    obj.button39:setParent(obj.layout52);
    ...
    obj.button39:setHint("Rolar 1d20 + Diplomacia");
    obj.button39:setName("button39");
    obj.button39:setTextTrimming("none");

    obj.totaldiplomacia = GUI.fromHandle(_obj_newObject("edit"));
    obj.totaldiplomacia:setParent(obj.layout52);
    ...
    obj.rectangle130:setParent(obj.layout52);
    ...
    obj.label124:setParent(obj.layout52);
    obj.label124:setLeft(292);
    ...
    obj.graddiplomacia:setParent(obj.layout52);
    ...
    obj.rectangle131:setParent(obj.layout52);
    ...
    obj.label125:setParent(obj.layout52);
    obj.label125:setLeft(353);
    ...
    obj.moddiplomacia:setParent(obj.layout52);
    ...
    obj.rectangle132:setParent(obj.layout52);
    ...
    obj.label126:setParent(obj.layout52);
    obj.label126:setLeft(419);
    ...
    obj.outrosdiplomacia:setParent(obj.layout52);
    ...
    obj.rectangle133:setParent(obj.layout53);
    ...
    obj.imageCheckBox11:setParent(obj.layout53);
    ...
    obj.button40:setParent(obj.layout53);
    ...
    obj.button40:setTextTrimming("none");

    obj.label127 = GUI.fromHandle(_obj_newObject("label"));
    obj.label127:setParent(obj.layout53);
    obj.label127:setLeft(50);
    obj.label127:setTop(5);
    obj.label127:setWidth(150);
    obj.label127:setHeight(20);
    obj.label127:setText("Enganação");
    obj.label127:setHorzTextAlign("leading");
    obj.label127:setFontSize(15.0);
    ...
    obj.button41:setParent(obj.layout53);
    ...
    obj.button41:setHint("Rolar 1d20 + Enganação");
    obj.button41:setName("button41");
    obj.button41:setTextTrimming("none");

    obj.totalenganacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalenganacao:setParent(obj.layout53);
    ...
    obj.rectangle134:setParent(obj.layout53);
    ...
    obj.label128:setParent(obj.layout53);
    obj.label128:setLeft(292);
    ...
    obj.gradenganacao:setParent(obj.layout53);
    ...
    obj.rectangle135:setParent(obj.layout53);
    ...
    obj.label129:setParent(obj.layout53);
    obj.label129:setLeft(353);
    ...
    obj.modenganacao:setParent(obj.layout53);
    ...
    obj.rectangle136:setParent(obj.layout53);
    ...
    obj.label130:setParent(obj.layout53);
    obj.label130:setLeft(419);
    ...
    obj.outrosenganacao:setParent(obj.layout53);
    ...
    obj.imageCheckBox12:setParent(obj.layout54);
    ...
    obj.button42:setParent(obj.layout54);
    ...
    obj.button42:setTextTrimming("none");

    obj.label131 = GUI.fromHandle(_obj_newObject("label"));
    obj.label131:setParent(obj.layout54);
    ...
    obj.button43:setParent(obj.layout54);
    ...
    obj.rectangle138:setParent(obj.layout54);
    ...
    obj.label132:setParent(obj.layout54);
    obj.label132:setLeft(292);
    ...
    obj.gradfurtividade:setParent(obj.layout54);
    ...
    obj.rectangle139:setParent(obj.layout54);
    ...
    obj.label133:setParent(obj.layout54);
    obj.label133:setLeft(353);
    ...
    obj.modfurtividade:setParent(obj.layout54);
    ...
    obj.rectangle140:setParent(obj.layout54);
    ...
    obj.label134:setParent(obj.layout54);
    obj.label134:setLeft(419);
    ...
    obj.outrosfurtividade:setParent(obj.layout54);
    ...
    obj.imageCheckBox13:setParent(obj.layout55);
    ...
    obj.button44:setParent(obj.layout55);
    ...
    obj.button44:setTextTrimming("none");

    obj.label135 = GUI.fromHandle(_obj_newObject("label"));
    obj.label135:setParent(obj.layout55);
    obj.label135:setLeft(50);
    obj.label135:setTop(5);
    obj.label135:setWidth(150);
    obj.label135:setHeight(20);
    obj.label135:setText("Identificar Magia ❄");
    obj.label135:setHorzTextAlign("leading");
    obj.label135:setFontSize(15.0);
    ...
    obj.button45:setParent(obj.layout55);
    ...
    obj.button45:setHint("Rolar 1d20 + Identificar Magia");
    obj.button45:setName("button45");
    obj.button45:setTextTrimming("none");

    obj.totalimagia = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalimagia:setParent(obj.layout55);
    ...
    obj.rectangle142:setParent(obj.layout55);
    ...
    obj.label136:setParent(obj.layout55);
    obj.label136:setLeft(292);
    ...
    obj.gradimagia:setParent(obj.layout55);
    ...
    obj.rectangle143:setParent(obj.layout55);
    ...
    obj.label137:setParent(obj.layout55);
    obj.label137:setLeft(353);
    ...
    obj.modimagia:setParent(obj.layout55);
    ...
    obj.rectangle144:setParent(obj.layout55);
    ...
    obj.label138:setParent(obj.layout55);
    obj.label138:setLeft(419);
    ...
    obj.outrosimagia:setParent(obj.layout55);
    ...
    obj.imageCheckBox14:setParent(obj.layout56);
    ...
    obj.button46:setParent(obj.layout56);
    ...
    obj.button46:setTextTrimming("none");

    obj.label139 = GUI.fromHandle(_obj_newObject("label"));
    obj.label139:setParent(obj.layout56);
    obj.label139:setLeft(50);
    obj.label139:setTop(5);
    obj.label139:setWidth(150);
    obj.label139:setHeight(20);
    obj.label139:setText("Iniciativa");
    obj.label139:setHorzTextAlign("leading");
    obj.label139:setFontSize(15.0);
    ...
    obj.button47:setParent(obj.layout56);
    ...
    obj.button47:setHint("Rolar 1d20 + Iniciativa");
    obj.button47:setName("button47");
    obj.button47:setTextTrimming("none");

    obj.totaliniciativa = GUI.fromHandle(_obj_newObject("edit"));
    obj.totaliniciativa:setParent(obj.layout56);
    ...
    obj.rectangle146:setParent(obj.layout56);
    ...
    obj.label140:setParent(obj.layout56);
    obj.label140:setLeft(292);
    ...
    obj.gradiniciativa:setParent(obj.layout56);
    ...
    obj.rectangle147:setParent(obj.layout56);
    ...
    obj.label141:setParent(obj.layout56);
    obj.label141:setLeft(353);
    ...
    obj.modiniciativa:setParent(obj.layout56);
    ...
    obj.rectangle148:setParent(obj.layout56);
    ...
    obj.label142:setParent(obj.layout56);
    obj.label142:setLeft(419);
    ...
    obj.outrosiniciativa:setParent(obj.layout56);
    ...
    obj.layout57:setParent(obj.layout42);
    obj.layout57:setLeft(0);
    obj.layout57:setTop(392);
    obj.layout57:setWidth(480);
    obj.layout57:setHeight(32);
    obj.layout57:setName("layout57");

    obj.rectangle149 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle149:setParent(obj.layout57);
    ...
    obj.imageCheckBox15:setParent(obj.layout57);
    ...
    obj.button48:setParent(obj.layout57);
    ...
    obj.button48:setTextTrimming("none");

    obj.label143 = GUI.fromHandle(_obj_newObject("label"));
    obj.label143:setParent(obj.layout57);
    obj.label143:setLeft(50);
    obj.label143:setTop(5);
    obj.label143:setWidth(150);
    obj.label143:setHeight(20);
    obj.label143:setText("Intimidação");
    obj.label143:setHorzTextAlign("leading");
    obj.label143:setFontSize(15.0);
    ...
    obj.button49:setParent(obj.layout57);
    ...
    obj.button49:setHint("Rolar 1d20 + Intimidação");
    obj.button49:setName("button49");
    obj.button49:setTextTrimming("none");

    obj.totalintimidacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalintimidacao:setParent(obj.layout57);
    ...
    obj.rectangle150:setParent(obj.layout57);
    ...
    obj.label144:setParent(obj.layout57);
    obj.label144:setLeft(292);
    ...
    obj.gradintimidacao:setParent(obj.layout57);
    ...
    obj.rectangle151:setParent(obj.layout57);
    ...
    obj.label145:setParent(obj.layout57);
    obj.label145:setLeft(353);
    ...
    obj.modintimidacao:setParent(obj.layout57);
    ...
    obj.rectangle152:setParent(obj.layout57);
    ...
    obj.label146:setParent(obj.layout57);
    obj.label146:setLeft(419);
    ...
    obj.outrosintimidacao:setParent(obj.layout57);
    ...
    obj.layout58:setParent(obj.layout42);
    obj.layout58:setLeft(0);
    obj.layout58:setTop(420);
    obj.layout58:setWidth(480);
    obj.layout58:setHeight(32);
    obj.layout58:setName("layout58");

    obj.rectangle153 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle153:setParent(obj.layout58);
    ...
    obj.imageCheckBox16:setParent(obj.layout58);
    ...
    obj.button50:setParent(obj.layout58);
    ...
    obj.button50:setTextTrimming("none");

    obj.label147 = GUI.fromHandle(_obj_newObject("label"));
    obj.label147:setParent(obj.layout58);
    obj.label147:setLeft(50);
    obj.label147:setTop(5);
    obj.label147:setWidth(150);
    obj.label147:setHeight(20);
    obj.label147:setText("Intuição");
    obj.label147:setHorzTextAlign("leading");
    obj.label147:setFontSize(15.0);
    ...
    obj.button51:setParent(obj.layout58);
    ...
    obj.button51:setHint("Rolar 1d20 + Intuição");
    obj.button51:setName("button51");
    obj.button51:setTextTrimming("none");

    obj.totalintuicao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalintuicao:setParent(obj.layout58);
    ...
    obj.rectangle154:setParent(obj.layout58);
    ...
    obj.label148:setParent(obj.layout58);
    obj.label148:setLeft(292);
    ...
    obj.gradintuicao:setParent(obj.layout58);
    ...
    obj.rectangle155:setParent(obj.layout58);
    ...
    obj.label149:setParent(obj.layout58);
    obj.label149:setLeft(353);
    ...
    obj.modintuicao:setParent(obj.layout58);
    ...
    obj.rectangle156:setParent(obj.layout58);
    ...
    obj.label150:setParent(obj.layout58);
    obj.label150:setLeft(419);
    ...
    obj.outrosintuicao:setParent(obj.layout58);
    ...
    obj.layout59:setParent(obj.layout42);
    obj.layout59:setLeft(0);
    obj.layout59:setTop(448);
    obj.layout59:setWidth(480);
    obj.layout59:setHeight(32);
    obj.layout59:setName("layout59");

    obj.rectangle157 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle157:setParent(obj.layout59);
    ...
    obj.imageCheckBox17:setParent(obj.layout59);
    ...
    obj.button52:setParent(obj.layout59);
    ...
    obj.button53:setParent(obj.layout59);
    ...
    obj.button53:setHint("Rolar 1d20 + Jogatina");
    obj.button53:setName("button53");
    obj.button53:setTextTrimming("none");

    obj.totaljogatina = GUI.fromHandle(_obj_newObject("edit"));
    obj.totaljogatina:setParent(obj.layout59);
    ...
    obj.rectangle158:setParent(obj.layout59);
    ...
    obj.label152:setParent(obj.layout59);
    obj.label152:setLeft(292);
    ...
    obj.gradjogatina:setParent(obj.layout59);
    ...
    obj.rectangle159:setParent(obj.layout59);
    ...
    obj.label153:setParent(obj.layout59);
    obj.label153:setLeft(353);
    ...
    obj.modjogatina:setParent(obj.layout59);
    ...
    obj.rectangle160:setParent(obj.layout59);
    ...
    obj.label154:setParent(obj.layout59);
    obj.label154:setLeft(419);
    ...
    obj.outrosjogatina:setParent(obj.layout59);
    ...
    obj.layout60:setParent(obj.layout42);
    obj.layout60:setLeft(0);
    obj.layout60:setTop(476);
    obj.layout60:setWidth(480);
    obj.layout60:setHeight(32);
    obj.layout60:setName("layout60");

    obj.rectangle161 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle161:setParent(obj.layout60);
    ...
    obj.imageCheckBox18:setParent(obj.layout60);
    ...
    obj.button54:setParent(obj.layout60);
    ...
    obj.button54:setTextTrimming("none");

    obj.label155 = GUI.fromHandle(_obj_newObject("label"));
    obj.label155:setParent(obj.layout60);
    obj.label155:setLeft(50);
    obj.label155:setTop(5);
    obj.label155:setWidth(150);
    obj.label155:setHeight(20);
    obj.label155:setText("Ladinagem ⚔❄");
    obj.label155:setHorzTextAlign("leading");
    obj.label155:setFontSize(15.0);
    ...
    obj.button55:setParent(obj.layout60);
    ...
    obj.button55:setHint("Rolar 1d20 + Ladinagem");
    obj.button55:setName("button55");
    obj.button55:setTextTrimming("none");

    obj.totalladinagem = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalladinagem:setParent(obj.layout60);
    ...
    obj.rectangle162:setParent(obj.layout60);
    ...
    obj.label156:setParent(obj.layout60);
    obj.label156:setLeft(292);
    ...
    obj.gradladinagem:setParent(obj.layout60);
    ...
    obj.rectangle163:setParent(obj.layout60);
    ...
    obj.label157:setParent(obj.layout60);
    obj.label157:setLeft(353);
    ...
    obj.modladinagem:setParent(obj.layout60);
    ...
    obj.rectangle164:setParent(obj.layout60);
    ...
    obj.outrosladinagem:setParent(obj.layout60);
    ...
    obj.layout61:setParent(obj.layout42);
    obj.layout61:setLeft(0);
    obj.layout61:setTop(504);
    obj.layout61:setWidth(480);
    obj.layout61:setHeight(32);
    obj.layout61:setName("layout61");

    obj.rectangle165 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle165:setParent(obj.layout61);
    ...
    obj.imageCheckBox19:setParent(obj.layout61);
    ...
    obj.button56:setParent(obj.layout61);
    ...
    obj.button57:setHint("Rolar 1d20 + Obter Informação");
    obj.button57:setName("button57");
    obj.button57:setTextTrimming("none");

    obj.totaloinformacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totaloinformacao:setParent(obj.layout61);
    ...
    obj.rectangle166:setParent(obj.layout61);
    ...
    obj.label160:setParent(obj.layout61);
    obj.label160:setLeft(292);
    ...
    obj.gradoinformacao:setParent(obj.layout61);
    ...
    obj.rectangle167:setParent(obj.layout61);
    ...
    obj.label161:setParent(obj.layout61);
    obj.label161:setLeft(353);
    ...
    obj.modoinformacao:setParent(obj.layout61);
    ...
    obj.rectangle168:setParent(obj.layout61);
    ...
    obj.label162:setParent(obj.layout61);
    obj.label162:setLeft(419);
    ...
    obj.outrosoinformacao:setParent(obj.layout61);
    ...
    obj.layout62:setParent(obj.layout42);
    obj.layout62:setLeft(0);
    obj.layout62:setTop(532);
    obj.layout62:setWidth(480);
    obj.layout62:setHeight(32);
    obj.layout62:setName("layout62");

    obj.rectangle169 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle169:setParent(obj.layout62);
    ...
    obj.imageCheckBox20:setParent(obj.layout62);
    ...
    obj.button59:setParent(obj.layout62);
    ...
    obj.button59:setTextTrimming("none");
    ...
    obj.totaloficio1:setParent(obj.layout62);
    ...
    obj.rectangle170:setParent(obj.layout62);
    ...
    obj.label164:setParent(obj.layout62);
    obj.label164:setLeft(292);
    ...
    obj.gradoficio1:setParent(obj.layout62);
    ...
    obj.rectangle171:setParent(obj.layout62);
    ...
    obj.label165:setParent(obj.layout62);
    obj.label165:setLeft(353);
    ...
    obj.modoficio1:setParent(obj.layout62);
    ...
    obj.rectangle172:setParent(obj.layout62);
    ...
    obj.label166:setParent(obj.layout62);
    obj.label166:setLeft(419);
    ...
    obj.outrosoficio1:setParent(obj.layout62);
    ...
    obj.layout63:setParent(obj.layout42);
    obj.layout63:setLeft(0);
    obj.layout63:setTop(560);
    obj.layout63:setWidth(480);
    obj.layout63:setHeight(32);
    obj.layout63:setName("layout63");

    obj.rectangle173 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle173:setParent(obj.layout63);
    ...
    obj.imageCheckBox21:setParent(obj.layout63);
    ...
    obj.button60:setParent(obj.layout63);
    ...
    obj.button60:setTextTrimming("none");

    obj.label167 = GUI.fromHandle(_obj_newObject("label"));
    obj.label167:setParent(obj.layout63);
    obj.label167:setLeft(50);
    obj.label167:setTop(5);
    obj.label167:setWidth(150);
    obj.label167:setHeight(20);
    obj.label167:setText("Ofício");
    obj.label167:setHorzTextAlign("leading");
    obj.label167:setFontSize(15.0);
    ...
    obj.button61:setParent(obj.layout63);
    ...
    obj.button61:setHint("Rolar 1d20 + Ofício");
    obj.button61:setName("button61");
    obj.button61:setTextTrimming("none");
    ...
    obj.totaloficio2:setParent(obj.layout63);
    ...
    obj.rectangle174:setParent(obj.layout63);
    ...
    obj.label168:setParent(obj.layout63);
    obj.label168:setLeft(292);
    ...
    obj.gradoficio2:setParent(obj.layout63);
    ...
    obj.rectangle175:setParent(obj.layout63);
    ...
    obj.label169:setParent(obj.layout63);
    obj.label169:setLeft(353);
    ...
    obj.modoficio2:setParent(obj.layout63);
    ...
    obj.rectangle176:setParent(obj.layout63);
    ...
    obj.label170:setParent(obj.layout63);
    obj.label170:setLeft(419);
    ...
    obj.outrosoficio2:setParent(obj.layout63);
    ...
    obj.layout64:setParent(obj.layout42);
    obj.layout64:setLeft(0);
    obj.layout64:setTop(588);
    obj.layout64:setWidth(480);
    obj.layout64:setHeight(32);
    obj.layout64:setName("layout64");

    obj.rectangle177 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle177:setParent(obj.layout64);
    ...
    obj.imageCheckBox22:setParent(obj.layout64);
    ...
    obj.button62:setParent(obj.layout64);
    ...
    obj.button62:setTextTrimming("none");

    obj.label171 = GUI.fromHandle(_obj_newObject("label"));
    obj.label171:setParent(obj.layout64);
    obj.label171:setLeft(50);
    obj.label171:setTop(5);
    obj.label171:setWidth(150);
    obj.label171:setHeight(20);
    obj.label171:setText("Meditação ❄");
    obj.label171:setHorzTextAlign("leading");
    obj.label171:setFontSize(15.0);
    ...
    obj.button63:setParent(obj.layout64);
    ...
    obj.button63:setHint("Rolar 1d20 + Meditação");
    obj.button63:setName("button63");
    obj.button63:setTextTrimming("none");

    obj.totalmeditacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalmeditacao:setParent(obj.layout64);
    ...
    obj.rectangle178:setParent(obj.layout64);
    ...
    obj.label172:setParent(obj.layout64);
    obj.label172:setLeft(292);
    ...
    obj.label172:setTextTrimming("none");

    obj.gradmeditacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.gradmeditacao:setParent(obj.layout64);
    ...
    obj.rectangle179:setParent(obj.layout64);
    ...
    obj.label173:setParent(obj.layout64);
    obj.label173:setLeft(353);
    ...
    obj.label173:setTextTrimming("none");

    obj.modmeditacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.modmeditacao:setParent(obj.layout64);
    ...
    obj.rectangle180:setParent(obj.layout64);
    ...
    obj.label174:setParent(obj.layout64);
    obj.label174:setLeft(419);
    ...
    obj.label174:setTextTrimming("none");

    obj.outrosmeditacao = GUI.fromHandle(_obj_newObject("edit"));
    obj.outrosmeditacao:setParent(obj.layout64);
    ...
    obj.layout65:setParent(obj.layout42);
    obj.layout65:setLeft(0);
    obj.layout65:setTop(616);
    obj.layout65:setWidth(480);
    obj.layout65:setHeight(32);
    obj.layout65:setName("layout65");

    obj.rectangle181 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle181:setParent(obj.layout65);
    ...
    obj.imageCheckBox23:setParent(obj.layout65);
    ...
    obj.button64:setParent(obj.layout65);
    ...
    obj.button65:setParent(obj.layout65);
    ...
    obj.button65:setHint("Rolar 1d20 + Percepção");
    obj.button65:setName("button65");
    obj.button65:setTextTrimming("none");

    obj.totalpercepcao = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalpercepcao:setParent(obj.layout65);
    ...
    obj.rectangle182:setParent(obj.layout65);
    ...
    obj.gradpercepcao:setParent(obj.layout65);
    ...
    obj.rectangle183:setParent(obj.layout65);
    ...
    obj.modpercepcao:setParent(obj.layout65);
    ...
    obj.rectangle184:setParent(obj.layout65);
    ...
    obj.outrospercepcao:setParent(obj.layout65);
    ...
    obj.layout66:setParent(obj.layout42);
    obj.layout66:setLeft(0);
    obj.layout66:setTop(644);
    obj.layout66:setWidth(480);
    obj.layout66:setHeight(32);
    obj.layout66:setName("layout66");

    obj.rectangle185 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle185:setParent(obj.layout66);
    ...
    obj.imageCheckBox24:setParent(obj.layout66);
    ...
    obj.button67:setParent(obj.layout66);
    obj.button67:setLeft(50);
    obj.button67:setTop(5);
    obj.button67:setWidth(150);
    obj.button67:setHeight(20);
    obj.button67:setOpacity(0.0);
    obj.button67:setCanFocus(false);
    obj.button67:setCursor("handPoint");
    obj.button67:setHint("Rolar 1d20 + Sobrevivência");
    obj.button67:setName("button67");
    obj.button67:setTextTrimming("none");

    obj.totalsobrevivencia = GUI.fromHandle(_obj_newObject("edit"));
    obj.totalsobrevivencia:setParent(obj.layout66);
    ...
    obj.rectangle186:setParent(obj.layout66);
    obj.rectangle186:setLeft(290);
    obj.rectangle186:setTop(8);
    obj.rectangle186:setColor("Black");
    obj.rectangle186:setWidth(20);
    ...
    obj.gradsobrevivencia:setParent(obj.layout66);
    ...
    obj.rectangle187:setParent(obj.layout66);
    obj.rectangle187:setLeft(350);
    obj.rectangle187:setTop(8);
    obj.rectangle187:setColor("Black");
    obj.rectangle187:setWidth(20);
    ...
    obj.label181:setLeft(353);
    obj.label181:setTop(6);
    obj.label181:setWidth(20);
    ...
    obj.modsobrevivencia:setParent(obj.layout66);
    ...
    obj.rectangle188:setParent(obj.layout66);
    obj.rectangle188:setLeft(416);
    obj.rectangle188:setTop(8);
    obj.rectangle188:setColor("Black");
    obj.rectangle188:setWidth(20);
    ...
    obj.label182:setLeft(419);
    obj.label182:setTop(6);
    obj.label182:setWidth(20);
    ...
    obj.outrossobrevivencia:setParent(obj.layout66);
    ...
    obj.layout67:setParent(obj.lytCanvas02);
    obj.layout67:setLeft(470);
    obj.layout67:setTop(0);
    obj.layout67:setWidth(545);
    obj.layout67:setHeight(700);
    obj.layout67:setName("layout67");

    obj.rectangle189 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle189:setParent(obj.layout67);
    obj.rectangle189:setLeft(115);
    obj.rectangle189:setTop(1);
    obj.rectangle189:setColor("Black");
    obj.rectangle189:setWidth(45);
    ...
    obj.label183:setParent(obj.layout67);
    obj.label183:setLeft(118);
    obj.label183:setTop(2);
    obj.label183:setWidth(58);
    ...
    obj.label183:setText("Talentos");
    obj.label183:setName("label183");
    obj.label183:setTextTrimming("none");

    obj.rectangle190 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle190:setParent(obj.layout67);
    obj.rectangle190:setLeft(357);
    obj.rectangle190:setTop(1);
    obj.rectangle190:setColor("Black");
    obj.rectangle190:setWidth(105);
    ...
    obj.label184:setParent(obj.layout67);
    obj.label184:setLeft(360);
    obj.label184:setTop(2);
    obj.label184:setWidth(98);
    obj.label184:setHeight(8);
    obj.label184:setFontSize(10);
    lfm_setPropAsString(obj.label184, "fontStyle", "bold");
    obj.label184:setFontColor("white");
    obj.label184:setText("Habilidades de Raça");
    ...
    obj.rectangle191:setLeft(357);
    obj.rectangle191:setTop(332);
    obj.rectangle191:setColor("Black");
    obj.rectangle191:setWidth(107);
    ...
    obj.layout68:setTop(11);
    obj.layout68:setWidth(255);
    obj.layout68:setHeight(686);
    ...
    obj.layout69:setLeft(275);
    obj.layout69:setTop(11);
    obj.layout69:setWidth(260);
    obj.layout69:setHeight(317);
    ...
    obj.layout70:setLeft(275);
    obj.layout70:setTop(344);
    obj.layout70:setWidth(260);
    obj.layout70:setHeight(354);
    ...
    obj.layout71:setParent(obj.lytCanvas02);
    obj.layout71:setLeft(6);
    obj.layout71:setTop(680);
    obj.layout71:setWidth(300);
    obj.layout71:setHeight(20);
    obj.layout71:setName("layout71");

    obj.label186 = GUI.fromHandle(_obj_newObject("label"));
    obj.label186:setParent(obj.layout71);
    obj.label186:setLeft(0);
    obj.label186:setTop(0);
    obj.label186:setWidth(150);
    obj.label186:setHeight(20);
    obj.label186:setText("⚔ Penalidade de armadura");
    obj.label186:setFontSize(12);
    obj.label186:setFontColor("#333333");
    obj.label186:setHitTest(true);
    obj.label186:setHint("Armaduras e Escudos dão penalidade nessas pericias");
    ...
    obj.label187:setParent(obj.layout71);
    obj.label187:setLeft(160);
    obj.label187:setTop(0);
    obj.label187:setWidth(140);
    obj.label187:setHeight(20);
    obj.label187:setText("❄ Somente treinado");
    obj.label187:setFontSize(12);
    obj.label187:setFontColor("#333333");
    obj.label187:setHitTest(true);
    obj.label187:setHint("Essas pericias só podem ser utilizadas caso sejam treinadas");
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
        ...
        if TRPG_updateScale == nil then
			...
			function recalcAll2()
				...
				local penO = math.floor(N(sheet.penoutros))
				local penC = math.floor(N(sheet.pencarga))

				-- totalPericia(grad, mod, outros, sofrePenArmadura, sofrePenCarga)
				local function totalPericia(grad, mod, outros, sofrePenArmadura, sofrePenCarga)
					local t = math.floor(N(grad)) + math.floor(N(mod)) + math.floor(N(outros))

					if sofrePenArmadura then
						t = t - penA - penE - penO
					end

					if sofrePenCarga then
						t = t - penC
					end
				...
				-- ⚔ = sofre penalidade de armadura/escudo/outros + carga
				-- (Aqui estou assumindo que CARGA afeta as mesmas ⚔)
				-- Se quiser mudar isso depois, é só alterar o último boolean.

				-- Acrobacia ⚔
				sheet.modacrobacia = TRPG_getMod(sheet, sheet.hab_acrobacia, 0)
				if sheet.cbxacrobacia then sheet.gradacrobacia = math.floor(nivel + 3) else sheet.gradacrobacia = math.floor(metanivel) end
				sheet.totalacrobacia = totalPericia(sheet.gradacrobacia, sheet.modacrobacia, sheet.outrosacrobacia, true, true)

				-- Adestrar Animais ❄ (sem penalidades)
				sheet.modadestrar = TRPG_getMod(sheet, sheet.hab_adestrar, 0)
				if sheet.cbxadestrar then sheet.gradadestrar = math.floor(nivel + 3) else sheet.gradadestrar = math.floor(metanivel) end
				sheet.totaladestrar = totalPericia(sheet.gradadestrar, sheet.modadestrar, sheet.outrosadestrar, false, false)

				-- Atletismo ⚔
				sheet.modatletismo = TRPG_getMod(sheet, sheet.hab_atletismo, 0)
				if sheet.cbxatletismo then sheet.gradatletismo = math.floor(nivel + 3) else sheet.gradatletismo = math.floor(metanivel) end
				sheet.totalatletismo = totalPericia(sheet.gradatletismo, sheet.modatletismo, sheet.outrosatletismo, true, true)

				-- Atuação (1)
				sheet.modatuacao1 = TRPG_getMod(sheet, sheet.hab_atuacao1, 0)
				if sheet.cbxatuacao1 then sheet.gradatuacao1 = math.floor(nivel + 3) else sheet.gradatuacao1 = math.floor(metanivel) end
				sheet.totalatuacao1 = totalPericia(sheet.gradatuacao1, sheet.modatuacao1, sheet.outrosatuacao1, false, false)

				-- Atuação (2)
				sheet.modatuacao2 = TRPG_getMod(sheet, sheet.hab_atuacao2, 0)
				if sheet.cbxatuacao2 then sheet.gradatuacao2 = math.floor(nivel + 3) else sheet.gradatuacao2 = math.floor(metanivel) end
				sheet.totalatuacao2 = totalPericia(sheet.gradatuacao2, sheet.modatuacao2, sheet.outrosatuacao2, false, false)

				-- Cavalgar
				sheet.modcavalgar = TRPG_getMod(sheet, sheet.hab_cavalgar, 0)
				if sheet.cbxcavalgar then sheet.gradcavalgar = math.floor(nivel + 3) else sheet.gradcavalgar = math.floor(metanivel) end
				sheet.totalcavalgar = totalPericia(sheet.gradcavalgar, sheet.modcavalgar, sheet.outroscavalgar, true, true)

				-- Conhecimento (1) ❄
				sheet.modconhecimento1 = TRPG_getMod(sheet, sheet.hab_conhecimento1, 0)
				if sheet.cbxconhecimento1 then sheet.gradconhecimento1 = math.floor(nivel + 3) else sheet.gradconhecimento1 = math.floor(metanivel) end
				sheet.totalconhecimento1 = totalPericia(sheet.gradconhecimento1, sheet.modconhecimento1, sheet.outrosconhecimento1, false, false)

				-- Conhecimento (2) ❄
				sheet.modconhecimento2 = TRPG_getMod(sheet, sheet.hab_conhecimento2, 0)
				if sheet.cbxconhecimento2 then sheet.gradconhecimento2 = math.floor(nivel + 3) else sheet.gradconhecimento2 = math.floor(metanivel) end
				sheet.totalconhecimento2 = totalPericia(sheet.gradconhecimento2, sheet.modconhecimento2, sheet.outrosconhecimento2, false, false)

				-- Cura
				sheet.modcura = TRPG_getMod(sheet, sheet.hab_cura, 0)
				if sheet.cbxcura then sheet.gradcura = math.floor(nivel + 3) else sheet.gradcura = math.floor(metanivel) end
				sheet.totalcura = totalPericia(sheet.gradcura, sheet.modcura, sheet.outroscura, false, false)

				-- Diplomacia
				sheet.moddiplomacia = TRPG_getMod(sheet, sheet.hab_diplomacia, 0)
				if sheet.cbxdiplomacia then sheet.graddiplomacia = math.floor(nivel + 3) else sheet.graddiplomacia = math.floor(metanivel) end
				sheet.totaldiplomacia = totalPericia(sheet.graddiplomacia, sheet.moddiplomacia, sheet.outrosdiplomacia, false, false)

				-- Enganação
				sheet.modenganacao = TRPG_getMod(sheet, sheet.hab_enganacao, 0)
				if sheet.cbxenganacao then sheet.gradenganacao = math.floor(nivel + 3) else sheet.gradenganacao = math.floor(metanivel) end
				sheet.totalenganacao = totalPericia(sheet.gradenganacao, sheet.modenganacao, sheet.outrosenganacao, false, false)

				-- Furtividade ⚔
				sheet.modfurtividade = TRPG_getMod(sheet, sheet.hab_furtividade, 0)
				if sheet.cbxfurtividade then sheet.gradfurtividade = math.floor(nivel + 3) else sheet.gradfurtividade = math.floor(metanivel) end
				sheet.totalfurtividade = totalPericia(sheet.gradfurtividade, sheet.modfurtividade, sheet.outrosfurtividade, true, true)

				-- Identificar Magia ❄
				sheet.modimagia = TRPG_getMod(sheet, sheet.hab_imagia, 0)
				if sheet.cbximagia then sheet.gradimagia = math.floor(nivel + 3) else sheet.gradimagia = math.floor(metanivel) end
				sheet.totalimagia = totalPericia(sheet.gradimagia, sheet.modimagia, sheet.outrosimagia, false, false)

				-- Iniciativa
				sheet.modiniciativa = TRPG_getMod(sheet, sheet.hab_iniciativa, 0)
				if sheet.cbxiniciativa then sheet.gradiniciativa = math.floor(nivel + 3) else sheet.gradiniciativa = math.floor(metanivel) end
				sheet.totaliniciativa = totalPericia(sheet.gradiniciativa, sheet.modiniciativa, sheet.outrosiniciativa, false, false)

				-- Intimidação
				sheet.modintimidacao = TRPG_getMod(sheet, sheet.hab_intimidacao, 0)
				if sheet.cbxintimidacao then sheet.gradintimidacao = math.floor(nivel + 3) else sheet.gradintimidacao = math.floor(metanivel) end
				sheet.totalintimidacao = totalPericia(sheet.gradintimidacao, sheet.modintimidacao, sheet.outrosintimidacao, false, false)

				-- Intuição
				sheet.modintuicao = TRPG_getMod(sheet, sheet.hab_intuicao, 0)
				if sheet.cbxintuicao then sheet.gradintuicao = math.floor(nivel + 3) else sheet.gradintuicao = math.floor(metanivel) end
				sheet.totalintuicao = totalPericia(sheet.gradintuicao, sheet.modintuicao, sheet.outrosintuicao, false, false)

				-- Jogatina
				sheet.modjogatina = TRPG_getMod(sheet, sheet.hab_jogatina, 0)
				if sheet.cbxjogatina then sheet.gradjogatina = math.floor(nivel + 3) else sheet.gradjogatina = math.floor(metanivel) end
				sheet.totaljogatina = totalPericia(sheet.gradjogatina, sheet.modjogatina, sheet.outrosjogatina, false, false)

				-- Ladinagem ⚔❄
				sheet.modladinagem = TRPG_getMod(sheet, sheet.hab_ladinagem, 0)
				if sheet.cbxladinagem then sheet.gradladinagem = math.floor(nivel + 3) else sheet.gradladinagem = math.floor(metanivel) end
				sheet.totalladinagem = totalPericia(sheet.gradladinagem, sheet.modladinagem, sheet.outrosladinagem, true, true)

				-- Obter Informação
				sheet.modoinformacao = TRPG_getMod(sheet, sheet.hab_oinformacao, 0)
				if sheet.cbxoinformacao then sheet.gradoinformacao = math.floor(nivel + 3) else sheet.gradoinformacao = math.floor(metanivel) end
				sheet.totaloinformacao = totalPericia(sheet.gradoinformacao, sheet.modoinformacao, sheet.outrosoinformacao, false, false)

				-- Ofício (1)
				sheet.modoficio1 = TRPG_getMod(sheet, sheet.hab_oficio1, 0)
				if sheet.cbxoficio1 then sheet.gradoficio1 = math.floor(nivel + 3) else sheet.gradoficio1 = math.floor(metanivel) end
				sheet.totaloficio1 = totalPericia(sheet.gradoficio1, sheet.modoficio1, sheet.outrosoficio1, false, false)

				-- Ofício (2)
				sheet.modoficio2 = TRPG_getMod(sheet, sheet.hab_oficio2, 0)
				if sheet.cbxoficio2 then sheet.gradoficio2 = math.floor(nivel + 3) else sheet.gradoficio2 = math.floor(metanivel) end
				sheet.totaloficio2 = totalPericia(sheet.gradoficio2, sheet.modoficio2, sheet.outrosoficio2, false, false)

				-- Meditação ❄
				sheet.modmeditacao = TRPG_getMod(sheet, sheet.hab_meditacao, 0)
				if sheet.cbxmeditacao then sheet.gradmeditacao = math.floor(nivel + 3) else sheet.gradmeditacao = math.floor(metanivel) end
				sheet.totalmeditacao = totalPericia(sheet.gradmeditacao, sheet.modmeditacao, sheet.outrosmeditacao, false, false)

				-- Percepção
				sheet.modpercepcao = TRPG_getMod(sheet, sheet.hab_percepcao, 0)
				if sheet.cbxpercepcao then sheet.gradpercepcao = math.floor(nivel + 3) else sheet.gradpercepcao = math.floor(metanivel) end
				sheet.totalpercepcao = totalPericia(sheet.gradpercepcao, sheet.modpercepcao, sheet.outrospercepcao, false, false)

				-- Sobrevivência
				sheet.modsobrevivencia = TRPG_getMod(sheet, sheet.hab_sobrevivencia, 0)
				if sheet.cbxsobrevivencia then sheet.gradsobrevivencia = math.floor(nivel + 3) else sheet.gradsobrevivencia = math.floor(metanivel) end
				sheet.totalsobrevivencia = totalPericia(sheet.gradsobrevivencia, sheet.modsobrevivencia, sheet.outrossobrevivencia, false, false)
			end
    ...
    obj.Tormenta03:setWidth(1010);
    obj.Tormenta03:setHeight(700);
    obj.Tormenta03:setMinWidth(700);
    obj.Tormenta03:setMaxWidth(1280);
    ...
    obj.lytCanvas03:setTop(0);
    obj.lytCanvas03:setWidth(1010);
    obj.lytCanvas03:setHeight(700);
    obj.lytCanvas03:setMargins({left=0,top=0,right=0,bottom=0});

    obj.rectangle192 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle192:setParent(obj.lytCanvas03);
    obj.rectangle192:setAlign("client");
    obj.rectangle192:setColor("LightGray");
    obj.rectangle192:setXradius(10);
    obj.rectangle192:setYradius(10);
    obj.rectangle192:setName("rectangle192");

    obj.content = GUI.fromHandle(_obj_newObject("layout"));
    obj.content:setParent(obj.lytCanvas03);
    ...
    obj.layout72:setParent(obj.colEsq);
    obj.layout72:setAlign("top");
    obj.layout72:setHeight(335);
    obj.layout72:setMargins({bottom=6});
    obj.layout72:setName("layout72");

    obj.rectangle193 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle193:setParent(obj.layout72);
    obj.rectangle193:setAlign("client");
    obj.rectangle193:setColor("Gray");
    obj.rectangle193:setXradius(6);
    obj.rectangle193:setYradius(6);
    obj.rectangle193:setHitTest(false);
    obj.rectangle193:setName("rectangle193");

    obj.rcArmaCloseArea = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rcArmaCloseArea:setParent(obj.layout72);
    obj.rcArmaCloseArea:setName("rcArmaCloseArea");
    obj.rcArmaCloseArea:setAlign("client");
    obj.rcArmaCloseArea:setColor("Transparent");
    obj.rcArmaCloseArea:setHitTest(true);

    obj.layout73 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout73:setParent(obj.layout72);
    obj.layout73:setAlign("client");
    obj.layout73:setMargins({left=6,right=6,top=6,bottom=6});
    obj.layout73:setHitTest(true);
    ...
    obj.layout74:setMargins({bottom=2});
    obj.layout74:setHitTest(false);
    obj.layout74:setName("layout74");

    obj.rectangle194 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle194:setParent(obj.layout74);
    obj.rectangle194:setAlign("client");
    obj.rectangle194:setColor("Black");
    obj.rectangle194:setXradius(4);
    obj.rectangle194:setYradius(4);
    obj.rectangle194:setHitTest(false);
    obj.rectangle194:setName("rectangle194");

    obj.label188 = GUI.fromHandle(_obj_newObject("label"));
    obj.label188:setParent(obj.layout74);
    ...
    obj.label188:setText("ARMAS");
    obj.label188:setHitTest(false);
    ...
    obj.layout75:setMargins({bottom=2});
    obj.layout75:setHitTest(true);
    obj.layout75:setName("layout75");

    obj.button68 = GUI.fromHandle(_obj_newObject("button"));
    obj.button68:setParent(obj.layout75);
    obj.button68:setAlign("left");
    obj.button68:setWidth(160);
    obj.button68:setFontColor("black");
    obj.button68:setText("Adicionar Arma");
    obj.button68:setName("button68");
    obj.button68:setTextTrimming("none");
    ...
    obj.label192:setText("Dano");
    obj.label192:setHitTest(false);
    ...
    obj.layout77:setHeight(150);
    obj.layout77:setMargins({bottom=6});
    obj.layout77:setHitTest(true);
    obj.layout77:setName("layout77");

    obj.rclArmas = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rclArmas:setParent(obj.layout77);
    ...
    obj.layout78:setHitTest(true);
    obj.layout78:setName("layout78");

    obj.boxArmaDetalhes = GUI.fromHandle(_obj_newObject("dataScopeBox"));
    obj.boxArmaDetalhes:setParent(obj.layout78);
    obj.boxArmaDetalhes:setName("boxArmaDetalhes");
    obj.boxArmaDetalhes:setVisible(false);
    obj.boxArmaDetalhes:setAlign("client");

    obj.rectangle195 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle195:setParent(obj.boxArmaDetalhes);
    obj.rectangle195:setAlign("client");
    obj.rectangle195:setColor("LightGray");
    obj.rectangle195:setXradius(6);
    obj.rectangle195:setYradius(6);
    obj.rectangle195:setPadding({left=6,right=6,top=6,bottom=6});
    obj.rectangle195:setName("rectangle195");

    obj.layout79 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout79:setParent(obj.rectangle195);
    obj.layout79:setAlign("top");
    obj.layout79:setHeight(26);
    obj.layout79:setMargins({bottom=6});
    obj.layout79:setHitTest(true);
    obj.layout79:setName("layout79");

    obj.lblArmaTitulo = GUI.fromHandle(_obj_newObject("label"));
    obj.lblArmaTitulo:setParent(obj.layout79);
    obj.lblArmaTitulo:setName("lblArmaTitulo");
    obj.lblArmaTitulo:setAlign("client");
    lfm_setPropAsString(obj.lblArmaTitulo, "fontStyle", "bold");
    obj.lblArmaTitulo:setFontColor("black");
    obj.lblArmaTitulo:setHorzTextAlign("center");
    obj.lblArmaTitulo:setText("Detalhes da Arma");
    obj.lblArmaTitulo:setHitTest(false);
    obj.lblArmaTitulo:setTextTrimming("none");

    obj.button69 = GUI.fromHandle(_obj_newObject("button"));
    obj.button69:setParent(obj.layout79);
    obj.button69:setAlign("right");
    obj.button69:setWidth(90);
    obj.button69:setFontColor("black");
    obj.button69:setText("Fechar");
    obj.button69:setName("button69");
    obj.button69:setTextTrimming("none");

    obj.textEditor4 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor4:setParent(obj.rectangle195);
    ...
    obj.dataLink3:setParent(obj.rectangle195);
    obj.dataLink3:setFields({'arma'});
    obj.dataLink3:setName("dataLink3");

    obj.layout80 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout80:setParent(obj.colEsq);
    obj.layout80:setAlign("client");
    obj.layout80:setName("layout80");

    obj.rectangle196 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle196:setParent(obj.layout80);
    obj.rectangle196:setAlign("client");
    obj.rectangle196:setColor("Gray");
    obj.rectangle196:setXradius(6);
    obj.rectangle196:setYradius(6);
    obj.rectangle196:setHitTest(false);
    obj.rectangle196:setName("rectangle196");

    obj.rcDefCloseArea = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rcDefCloseArea:setParent(obj.layout80);
    obj.rcDefCloseArea:setName("rcDefCloseArea");
    obj.rcDefCloseArea:setAlign("client");
    obj.rcDefCloseArea:setColor("Transparent");
    obj.rcDefCloseArea:setHitTest(true);

    obj.layout81 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout81:setParent(obj.layout80);
    obj.layout81:setAlign("client");
    obj.layout81:setMargins({left=6,right=6,top=6,bottom=6});
    obj.layout81:setHitTest(true);
    obj.layout81:setName("layout81");

    obj.layout82 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout82:setParent(obj.layout81);
    obj.layout82:setAlign("top");
    obj.layout82:setHeight(28);
    obj.layout82:setMargins({bottom=2});
    obj.layout82:setHitTest(false);
    obj.layout82:setName("layout82");

    obj.rectangle197 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle197:setParent(obj.layout82);
    obj.rectangle197:setAlign("client");
    obj.rectangle197:setColor("Black");
    obj.rectangle197:setXradius(4);
    obj.rectangle197:setYradius(4);
    obj.rectangle197:setHitTest(false);
    obj.rectangle197:setName("rectangle197");

    obj.label198 = GUI.fromHandle(_obj_newObject("label"));
    obj.label198:setParent(obj.layout82);
    obj.label198:setAlign("client");
    obj.label198:setFontSize(14);
    lfm_setPropAsString(obj.label198, "fontStyle", "bold");
    obj.label198:setFontColor("white");
    obj.label198:setHorzTextAlign("center");
    obj.label198:setText("ARMADURAS / ESCUDOS / OUTROS");
    obj.label198:setHitTest(false);
    ...
    obj.layout83:setMargins({bottom=2});
    obj.layout83:setHitTest(true);
    obj.layout83:setName("layout83");

    obj.button70 = GUI.fromHandle(_obj_newObject("button"));
    obj.button70:setParent(obj.layout83);
    obj.button70:setAlign("left");
    obj.button70:setWidth(150);
    obj.button70:setFontColor("black");
    obj.button70:setText("Adicionar Armadura");
    obj.button70:setName("button70");
    obj.button70:setTextTrimming("none");

    obj.button71 = GUI.fromHandle(_obj_newObject("button"));
    obj.button71:setParent(obj.layout83);
    obj.button71:setAlign("left");
    obj.button71:setWidth(150);
    obj.button71:setMargins({left=8});
    obj.button71:setFontColor("black");
    obj.button71:setText("Adicionar Escudo");
    obj.button71:setName("button71");
    obj.button71:setTextTrimming("none");

    obj.button72 = GUI.fromHandle(_obj_newObject("button"));
    obj.button72:setParent(obj.layout83);
    obj.button72:setAlign("left");
    obj.button72:setWidth(150);
    obj.button72:setFontColor("black");
    obj.button72:setMargins({left=8});
    obj.button72:setText("Adicionar Outros");
    obj.button72:setName("button72");
    obj.button72:setTextTrimming("none");

    obj.layout84 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout84:setParent(obj.layout81);
    obj.layout84:setAlign("top");
    obj.layout84:setHeight(20);
    obj.layout84:setMargins({bottom=2});
    obj.layout84:setHitTest(false);
    obj.layout84:setName("layout84");

    obj.label199 = GUI.fromHandle(_obj_newObject("label"));
    obj.label199:setParent(obj.layout84);
    ...
    obj.layout85:setHeight(150);
    obj.layout85:setMargins({bottom=6});
    obj.layout85:setHitTest(true);
    obj.layout85:setName("layout85");

    obj.rclDefesas = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rclDefesas:setParent(obj.layout85);
    ...
    obj.layout86:setHitTest(true);
    obj.layout86:setName("layout86");

    obj.boxDefDetalhes = GUI.fromHandle(_obj_newObject("dataScopeBox"));
    obj.boxDefDetalhes:setParent(obj.layout86);
    obj.boxDefDetalhes:setName("boxDefDetalhes");
    obj.boxDefDetalhes:setVisible(false);
    obj.boxDefDetalhes:setAlign("client");

    obj.rectangle198 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle198:setParent(obj.boxDefDetalhes);
    obj.rectangle198:setAlign("client");
    obj.rectangle198:setColor("LightGray");
    obj.rectangle198:setXradius(6);
    obj.rectangle198:setYradius(6);
    obj.rectangle198:setPadding({left=6,right=6,top=6,bottom=6});
    obj.rectangle198:setName("rectangle198");

    obj.layout87 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout87:setParent(obj.rectangle198);
    obj.layout87:setAlign("top");
    obj.layout87:setHeight(26);
    obj.layout87:setMargins({bottom=6});
    obj.layout87:setHitTest(true);
    obj.layout87:setName("layout87");

    obj.lblDefTitulo = GUI.fromHandle(_obj_newObject("label"));
    obj.lblDefTitulo:setParent(obj.layout87);
    obj.lblDefTitulo:setName("lblDefTitulo");
    obj.lblDefTitulo:setAlign("client");
    lfm_setPropAsString(obj.lblDefTitulo, "fontStyle", "bold");
    obj.lblDefTitulo:setFontColor("black");
    obj.lblDefTitulo:setHorzTextAlign("center");
    obj.lblDefTitulo:setText("Detalhes da Defesa");
    obj.lblDefTitulo:setHitTest(false);
    obj.lblDefTitulo:setTextTrimming("none");

    obj.button73 = GUI.fromHandle(_obj_newObject("button"));
    obj.button73:setParent(obj.layout87);
    obj.button73:setAlign("right");
    obj.button73:setWidth(90);
    obj.button73:setFontColor("black");
    obj.button73:setText("Fechar");
    obj.button73:setName("button73");
    obj.button73:setTextTrimming("none");

    obj.textEditor5 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor5:setParent(obj.rectangle198);
    ...
    obj.dataLink4:setParent(obj.rectangle198);
    obj.dataLink4:setFields({'defesa'});
    ...
    obj.layout88:setParent(obj.colDir);
    obj.layout88:setAlign("top");
    obj.layout88:setHeight(560);
    obj.layout88:setMargins({top=0,bottom=4});
    obj.layout88:setName("layout88");

    obj.rectangle199 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle199:setParent(obj.layout88);
    obj.rectangle199:setAlign("client");
    obj.rectangle199:setColor("Gray");
    obj.rectangle199:setXradius(6);
    obj.rectangle199:setYradius(6);
    obj.rectangle199:setHitTest(false);
    obj.rectangle199:setName("rectangle199");

    obj.rcEquipCloseArea = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rcEquipCloseArea:setParent(obj.layout88);
    ...
    obj.layout89:setMargins({left=6,right=6,top=6,bottom=6});
    obj.layout89:setHitTest(true);
    ...
    obj.layout90:setMargins({bottom=2});
    obj.layout90:setHitTest(false);
    obj.layout90:setName("layout90");

    obj.rectangle200 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle200:setParent(obj.layout90);
    obj.rectangle200:setAlign("client");
    obj.rectangle200:setColor("Black");
    obj.rectangle200:setXradius(4);
    obj.rectangle200:setYradius(4);
    obj.rectangle200:setHitTest(false);
    obj.rectangle200:setName("rectangle200");

    obj.label207 = GUI.fromHandle(_obj_newObject("label"));
    obj.label207:setParent(obj.layout90);
    obj.label207:setAlign("client");
    obj.label207:setFontSize(14);
    lfm_setPropAsString(obj.label207, "fontStyle", "bold");
    obj.label207:setFontColor("white");
    obj.label207:setHorzTextAlign("center");
    obj.label207:setText("EQUIPAMENTO");
    obj.label207:setHitTest(false);
    ...
    obj.layout91:setHitTest(true);
    obj.layout91:setName("layout91");

    obj.button74 = GUI.fromHandle(_obj_newObject("button"));
    obj.button74:setParent(obj.layout91);
    obj.button74:setAlign("left");
    obj.button74:setWidth(190);
    obj.button74:setFontColor("black");
    obj.button74:setText("Adicionar Item");
    obj.button74:setName("button74");
    obj.button74:setTextTrimming("none");

    obj.label208 = GUI.fromHandle(_obj_newObject("label"));
    obj.label208:setParent(obj.layout91);
    obj.label208:setAlign("left");
    obj.label208:setWidth(140);
    obj.label208:setMargins({left=8});
    obj.label208:setHitTest(false);
    ...
    obj.layout92:setHeight(380);
    obj.layout92:setHitTest(true);
    ...
    obj.layout93:setMargins({bottom=2});
    obj.layout93:setHitTest(false);
    ...
    obj.layout94:setMargins({top=6});
    obj.layout94:setHitTest(true);
    obj.layout94:setName("layout94");

    obj.boxEquipDetalhes = GUI.fromHandle(_obj_newObject("dataScopeBox"));
    obj.boxEquipDetalhes:setParent(obj.layout94);
    ...
    obj.rectangle201:setParent(obj.boxEquipDetalhes);
    obj.rectangle201:setAlign("client");
    obj.rectangle201:setColor("LightGray");
    obj.rectangle201:setXradius(6);
    obj.rectangle201:setYradius(6);
    obj.rectangle201:setPadding({left=6,right=6,top=6,bottom=6});
    obj.rectangle201:setName("rectangle201");

    obj.layout95 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout95:setParent(obj.rectangle201);
    obj.layout95:setAlign("top");
    obj.layout95:setHeight(26);
    obj.layout95:setMargins({bottom=6});
    obj.layout95:setHitTest(true);
    obj.layout95:setName("layout95");

    obj.lblEquipTitulo = GUI.fromHandle(_obj_newObject("label"));
    obj.lblEquipTitulo:setParent(obj.layout95);
    ...
    obj.lblEquipTitulo:setTextTrimming("none");

    obj.button75 = GUI.fromHandle(_obj_newObject("button"));
    obj.button75:setParent(obj.layout95);
    obj.button75:setAlign("right");
    obj.button75:setWidth(90);
    obj.button75:setFontColor("black");
    obj.button75:setText("Fechar");
    obj.button75:setName("button75");
    obj.button75:setTextTrimming("none");

    obj.textEditor6 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor6:setParent(obj.rectangle201);
    ...
    obj.dataLink5:setParent(obj.rectangle201);
    obj.dataLink5:setFields({'nome'});
    obj.dataLink5:setName("dataLink5");

    obj.layout96 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout96:setParent(obj.colDir);
    obj.layout96:setAlign("client");
    obj.layout96:setMargins({left=6,right=6,top=0,bottom=6});
    obj.layout96:setName("layout96");

    obj.layout97 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout97:setParent(obj.layout96);
    obj.layout97:setAlign("top");
    obj.layout97:setHeight(120);
    obj.layout97:setName("layout97");

    obj.layout98 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout98:setParent(obj.layout97);
    obj.layout98:setAlign("left");
    obj.layout98:setWidth(240);
    obj.layout98:setName("layout98");

    obj.label215 = GUI.fromHandle(_obj_newObject("label"));
    obj.label215:setParent(obj.layout98);
    obj.label215:setAlign("top");
    obj.label215:setHeight(18);
    lfm_setPropAsString(obj.label215, "fontStyle", "bold");
    obj.label215:setFontColor("black");
    obj.label215:setText("Carga (regra automática)");
    ...
    obj.edit62:setField("cargaSemPenal");
    obj.edit62:setFontColor("black");
    obj.edit62:setType("float");
    obj.edit62:setMin(0);
    obj.edit62:setMax(999999);
    ...
    obj.label219:setParent(obj.layout102);
    obj.label219:setAlign("left");
    obj.label219:setWidth(120);
    obj.label219:setFontColor("black");
    obj.label219:setText("Status:");
    ...
    obj.edtCargaStatus:setParent(obj.layout103);
    ...
    obj.btnHintCargaStatus:setParent(obj.layout103);
    ...
    obj.edit64:setField("totalCobre");
    obj.edit64:setFontColor("black");
    obj.edit64:setType("number");
    obj.edit64:setMin(0);
    obj.edit64:setMax(999999);
    ...
    obj.edit65:setField("totalPrata");
    obj.edit65:setFontColor("black");
    obj.edit65:setType("number");
    obj.edit65:setMin(0);
    obj.edit65:setMax(999999);
    ...
    obj.label224:setParent(obj.layout108);
    obj.label224:setAlign("left");
    obj.label224:setWidth(90);
    obj.label224:setFontColor("black");
    obj.label224:setText("TL (Platina)");
    ...
    obj.edit67:setField("totalPlatina");
    obj.edit67:setFontColor("black");
    obj.edit67:setType("number");
    obj.edit67:setMin(0);
    obj.edit67:setMax(999999);
    obj.edit67:setHorzTextAlign("center");
    obj.edit67:setName("edit67");

    obj.dataLink6 = GUI.fromHandle(_obj_newObject("dataLink"));
    obj.dataLink6:setParent(obj.Tormenta03);
    obj.dataLink6:setFields({'__recalc03','forca','danoforca','pesototal','cargaSemPenal','cargaMaxima','listaArmas','listaDefesas','listaEquipamentos'});
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
    ...
    obj.Tormenta04:setWidth(1010);
    obj.Tormenta04:setHeight(700);
    obj.Tormenta04:setMinWidth(700);
    obj.Tormenta04:setMaxWidth(1280);
    ...
    obj.rectangle202:setParent(obj.lytCanvas04);
    obj.rectangle202:setWidth(1010);
    obj.rectangle202:setHeight(700);
    obj.rectangle202:setColor("LightGray");
    ...
    obj.rectangle203:setParent(obj.lytCanvas04);
    obj.rectangle203:setLeft(373);
    obj.rectangle203:setTop(10);
    obj.rectangle203:setColor("#333333");
    obj.rectangle203:setWidth(265);
    obj.rectangle203:setHeight(50);
    ...
    obj.rectangle204:setParent(obj.lytCanvas04);
    obj.rectangle204:setLeft(378);
    obj.rectangle204:setTop(15);
    obj.rectangle204:setColor("#999999");
    obj.rectangle204:setWidth(255);
    obj.rectangle204:setHeight(40);
    ...
    obj.rectangle205:setParent(obj.lytCanvas04);
    obj.rectangle205:setLeft(397);
    obj.rectangle205:setTop(28);
    obj.rectangle205:setColor("Black");
    obj.rectangle205:setWidth(90);
    ...
    obj.label227:setParent(obj.lytCanvas04);
    obj.label227:setLeft(509);
    obj.label227:setTop(18);
    obj.label227:setWidth(28);
    obj.label227:setHeight(8);
    obj.label227:setFontSize(10);
    lfm_setPropAsString(obj.label227, "fontStyle", "bold");
    obj.label227:setFontColor("white");
    obj.label227:setText("Total");
    ...
    obj.rectangle207:setParent(obj.lytCanvas04);
    obj.rectangle207:setLeft(564);
    obj.rectangle207:setTop(16);
    obj.rectangle207:setColor("Black");
    obj.rectangle207:setWidth(38);
    ...
    obj.label228:setParent(obj.lytCanvas04);
    obj.label228:setLeft(568);
    obj.label228:setTop(18);
    obj.label228:setWidth(38);
    obj.label228:setHeight(8);
    obj.label228:setFontSize(10);
    lfm_setPropAsString(obj.label228, "fontStyle", "bold");
    obj.label228:setFontColor("white");
    obj.label228:setText("Atuais");
    ...
    obj.rectangle208:setParent(obj.lytCanvas04);
    obj.rectangle208:setLeft(175);
    obj.rectangle208:setTop(46);
    obj.rectangle208:setColor("Black");
    obj.rectangle208:setWidth(160);
    obj.rectangle208:setHeight(28);
    ...
    obj.label229:setParent(obj.lytCanvas04);
    obj.label229:setLeft(183);
    obj.label229:setTop(47);
    obj.label229:setWidth(160);
    obj.label229:setHeight(23);
    obj.label229:setFontSize(16.0);
    lfm_setPropAsString(obj.label229, "fontStyle", "bold");
    obj.label229:setFontColor("white");
    obj.label229:setText("Magias Conhecidas");
    obj.label229:setName("label229");
    obj.label229:setTextTrimming("none");

    obj.layout109 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout109:setParent(obj.lytCanvas04);
    obj.layout109:setLeft(10);
    obj.layout109:setTop(72);
    obj.layout109:setWidth(490);
    obj.layout109:setHeight(615);
    obj.layout109:setName("layout109");

    obj.textEditor7 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor7:setParent(obj.layout109);
    obj.textEditor7:setAlign("client");
    obj.textEditor7:setField("mconhecidas");
    ...
    obj.rectangle209:setParent(obj.lytCanvas04);
    obj.rectangle209:setLeft(675);
    obj.rectangle209:setTop(46);
    obj.rectangle209:setColor("Black");
    obj.rectangle209:setWidth(160);
    obj.rectangle209:setHeight(28);
    ...
    obj.label230:setParent(obj.lytCanvas04);
    obj.label230:setLeft(683);
    obj.label230:setTop(47);
    obj.label230:setWidth(160);
    obj.label230:setHeight(23);
    obj.label230:setFontSize(16.0);
    lfm_setPropAsString(obj.label230, "fontStyle", "bold");
    obj.label230:setFontColor("white");
    obj.label230:setText("Magias Preparadas");
    obj.label230:setName("label230");
    obj.label230:setTextTrimming("none");

    obj.layout110 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout110:setParent(obj.lytCanvas04);
    obj.layout110:setLeft(510);
    obj.layout110:setTop(72);
    obj.layout110:setWidth(490);
    obj.layout110:setHeight(615);
    obj.layout110:setName("layout110");

    obj.textEditor8 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor8:setParent(obj.layout110);
    obj.textEditor8:setAlign("client");
    obj.textEditor8:setField("mpreparadas");
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
    ...
    obj.Tormenta05:setWidth(1010);
    obj.Tormenta05:setHeight(700);
    obj.Tormenta05:setMinWidth(700);
    obj.Tormenta05:setMaxWidth(1280);
    ...
    obj.lytCanvas05:setTop(0);
    obj.lytCanvas05:setWidth(1010);
    obj.lytCanvas05:setHeight(700);
    obj.lytCanvas05:setMargins({left=0,top=0,right=0,bottom=0});

    obj.rectangle210 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle210:setParent(obj.lytCanvas05);
    obj.rectangle210:setWidth(1010);
    obj.rectangle210:setHeight(700);
    obj.rectangle210:setColor("LightGray");
    obj.rectangle210:setXradius(10);
    obj.rectangle210:setYradius(10);
    obj.rectangle210:setName("rectangle210");

    obj.layout111 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout111:setParent(obj.lytCanvas05);
    obj.layout111:setLeft(10);
    obj.layout111:setTop(8);
    obj.layout111:setWidth(980);
    obj.layout111:setHeight(300);
    obj.layout111:setName("layout111");

    obj.rectangle211 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle211:setParent(obj.layout111);
    obj.rectangle211:setLeft(1);
    obj.rectangle211:setTop(230);
    obj.rectangle211:setColor("#333333");
    obj.rectangle211:setWidth(280);
    obj.rectangle211:setHeight(70);
    ...
    obj.rectangle212:setParent(obj.layout111);
    obj.rectangle212:setLeft(5);
    obj.rectangle212:setTop(235);
    obj.rectangle212:setColor("#999999");
    obj.rectangle212:setWidth(270);
    obj.rectangle212:setHeight(60);
    ...
    obj.rectangle213:setParent(obj.layout111);
    obj.rectangle213:setLeft(15);
    obj.rectangle213:setTop(238);
    obj.rectangle213:setColor("Black");
    obj.rectangle213:setWidth(120);
    ...
    obj.rectangle214:setParent(obj.layout111);
    obj.rectangle214:setLeft(15);
    obj.rectangle214:setTop(266);
    obj.rectangle214:setColor("Black");
    obj.rectangle214:setWidth(120);
    ...
    obj.rectangle215:setParent(obj.layout111);
    obj.rectangle215:setLeft(84);
    obj.rectangle215:setTop(3);
    obj.rectangle215:setColor("Black");
    obj.rectangle215:setWidth(115);
    obj.rectangle215:setHeight(28);
    ...
    obj.label235:setParent(obj.layout111);
    obj.label235:setLeft(90);
    obj.label235:setTop(5);
    obj.label235:setWidth(110);
    obj.label235:setHeight(20);
    obj.label235:setFontSize(18.0);
    lfm_setPropAsString(obj.label235, "fontStyle", "bold");
    obj.label235:setFontColor("white");
    obj.label235:setText("Informações");
    obj.label235:setName("label235");
    obj.label235:setTextTrimming("none");

    obj.textEditor9 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor9:setParent(obj.layout111);
    obj.textEditor9:setLeft(1);
    obj.textEditor9:setTop(27);
    obj.textEditor9:setWidth(280);
    obj.textEditor9:setHeight(202);
    obj.textEditor9:setFontColor("black");
    obj.textEditor9:setField("informacoes");
    obj.textEditor9:setName("textEditor9");

    obj.rectangle216 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle216:setParent(obj.layout111);
    obj.rectangle216:setLeft(600);
    obj.rectangle216:setTop(3);
    obj.rectangle216:setColor("Black");
    obj.rectangle216:setWidth(77);
    obj.rectangle216:setHeight(28);
    ...
    obj.layout112:setParent(obj.lytCanvas05);
    obj.layout112:setLeft(21);
    obj.layout112:setTop(316);
    obj.layout112:setWidth(969);
    obj.layout112:setHeight(358);
    obj.layout112:setName("layout112");

    obj.rectangle217 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle217:setParent(obj.layout112);
    obj.rectangle217:setLeft(86);
    obj.rectangle217:setTop(3);
    obj.rectangle217:setColor("Black");
    obj.rectangle217:setWidth(128);
    obj.rectangle217:setHeight(28);
    ...
    obj.rectangle218:setParent(obj.layout112);
    obj.rectangle218:setLeft(435);
    obj.rectangle218:setTop(3);
    obj.rectangle218:setColor("Black");
    obj.rectangle218:setWidth(93);
    ...
    obj.label238:setParent(obj.layout112);
    obj.label238:setLeft(439);
    obj.label238:setTop(6);
    obj.label238:setWidth(100);
    obj.label238:setHeight(20);
    obj.label238:setFontSize(18.0);
    ...
    obj.label239:setParent(obj.layout112);
    obj.label239:setLeft(774);
    obj.label239:setTop(6);
    obj.label239:setWidth(100);
    obj.label239:setHeight(20);
    obj.label239:setFontSize(18.0);
    lfm_setPropAsString(obj.label239, "fontStyle", "bold");
    obj.label239:setFontColor("white");
    obj.label239:setText("Anotações");
    obj.label239:setName("label239");
    obj.label239:setTextTrimming("none");

    obj.textEditor12 = GUI.fromHandle(_obj_newObject("textEditor"));
    obj.textEditor12:setParent(obj.layout112);
    obj.textEditor12:setLeft(669);
    obj.textEditor12:setTop(30);
    obj.textEditor12:setWidth(300);
    obj.textEditor12:setHeight(328);
    obj.textEditor12:setFontColor("black");
    obj.textEditor12:setField("anotacoes");
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
    ...
    obj.Tormenta06:setWidth(1010);
    obj.Tormenta06:setHeight(700);
    obj.Tormenta06:setMinWidth(700);
    obj.Tormenta06:setMaxWidth(1280);
    ...
    obj.rectangle220:setParent(obj.lytCanvas06);
    ...
    obj.layout113:setParent(obj.lytCanvas06);
    obj.layout113:setLeft(0);
    obj.layout113:setTop(0);
    obj.layout113:setWidth(1010);
    obj.layout113:setHeight(700);
    ...
    obj.layout114:setMargins({left=10,right=10,top=10,bottom=6});
    obj.layout114:setName("layout114");

    obj.rectangle221 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle221:setParent(obj.layout114);
    obj.rectangle221:setAlign("client");
    obj.rectangle221:setColor("Gainsboro");
    obj.rectangle221:setXradius(8);
    obj.rectangle221:setYradius(8);
    obj.rectangle221:setName("rectangle221");

    obj.layout115 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout115:setParent(obj.layout114);
    obj.layout115:setAlign("client");
    obj.layout115:setMargins({left=8,right=8,top=6,bottom=6});
    obj.layout115:setName("layout115");

    obj.button76 = GUI.fromHandle(_obj_newObject("button"));
    obj.button76:setParent(obj.layout115);
    obj.button76:setText("Adicionar (Ataque)");
    obj.button76:setWidth(170);
    obj.button76:setAlign("left");
    obj.button76:setName("button76");
    obj.button76:setTextTrimming("none");

    obj.button77 = GUI.fromHandle(_obj_newObject("button"));
    obj.button77:setParent(obj.layout115);
    obj.button77:setText("Adicionar (Danos)");
    obj.button77:setWidth(170);
    obj.button77:setAlign("left");
    obj.button77:setMargins({left=6});
    obj.button77:setName("button77");
    obj.button77:setTextTrimming("none");

    obj.button78 = GUI.fromHandle(_obj_newObject("button"));
    obj.button78:setParent(obj.layout115);
    obj.button78:setText("Adicionar (Magias)");
    obj.button78:setWidth(170);
    obj.button78:setAlign("left");
    obj.button78:setMargins({left=6});
    obj.button78:setName("button78");
    obj.button78:setTextTrimming("none");

    obj.layout116 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout116:setParent(obj.layout113);
    obj.layout116:setAlign("client");
    obj.layout116:setMargins({left=10, right=10, top=0, bottom=10});
    ...
    obj.rectangle222:setParent(obj.layout118);
    obj.rectangle222:setAlign("client");
    obj.rectangle222:setColor("Black");
    obj.rectangle222:setXradius(6);
    obj.rectangle222:setYradius(6);
    obj.rectangle222:setName("rectangle222");

    obj.layout119 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout119:setParent(obj.layout118);
    obj.layout119:setAlign("client");
    obj.layout119:setMargins({left=6,right=6,top=4,bottom=4});
    obj.layout119:setName("layout119");

    obj.label240 = GUI.fromHandle(_obj_newObject("label"));
    obj.label240:setParent(obj.layout119);
    obj.label240:setAlign("left");
    obj.label240:setWidth(240);
    ...
    obj.layout120:setMargins({top=6});
    obj.layout120:setName("layout120");

    obj.rectangle223 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle223:setParent(obj.layout120);
    obj.rectangle223:setAlign("client");
    obj.rectangle223:setColor("Gainsboro");
    obj.rectangle223:setXradius(8);
    obj.rectangle223:setYradius(8);
    obj.rectangle223:setName("rectangle223");

    obj.layout121 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout121:setParent(obj.layout120);
    obj.layout121:setAlign("client");
    obj.layout121:setMargins({left=6,right=6,top=6,bottom=6});
    obj.layout121:setName("layout121");

    obj.layout122 = GUI.fromHandle(_obj_newObject("layout"));
    obj.layout122:setParent(obj.layout121);
    obj.layout122:setAlign("left");
    obj.layout122:setWidth(240);
    obj.layout122:setMargins({right=4});
    obj.layout122:setName("layout122");

    obj.rectangle224 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle224:setParent(obj.layout122);
    obj.rectangle224:setAlign("client");
    obj.rectangle224:setColor("White");
    obj.rectangle224:setXradius(6);
    obj.rectangle224:setYradius(6);
    obj.rectangle224:setName("rectangle224");

    obj.rclAtaque = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rclAtaque:setParent(obj.layout122);
    ...
    obj.layout123:setWidth(240);
    obj.layout123:setMargins({left=2,right=2});
    obj.layout123:setName("layout123");

    obj.rectangle225 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle225:setParent(obj.layout123);
    obj.rectangle225:setAlign("client");
    obj.rectangle225:setColor("White");
    obj.rectangle225:setXradius(6);
    obj.rectangle225:setYradius(6);
    obj.rectangle225:setName("rectangle225");

    obj.rclDanos = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rclDanos:setParent(obj.layout123);
    ...
    obj.layout124:setMargins({left=4});
    obj.layout124:setName("layout124");

    obj.rectangle226 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle226:setParent(obj.layout124);
    obj.rectangle226:setAlign("client");
    obj.rectangle226:setColor("White");
    obj.rectangle226:setXradius(6);
    obj.rectangle226:setYradius(6);
    obj.rectangle226:setName("rectangle226");

    obj.rclMagias = GUI.fromHandle(_obj_newObject("recordList"));
    obj.rclMagias:setParent(obj.layout124);
    ...
    obj.layout125:setAlign("right");
    obj.layout125:setWidth(250);
    obj.layout125:setMargins({left=10});
    obj.layout125:setName("layout125");

    obj.rectangle227 = GUI.fromHandle(_obj_newObject("rectangle"));
    obj.rectangle227:setParent(obj.layout125);
    obj.rectangle227:setAlign("client");
    obj.rectangle227:setColor("Gray");
    obj.rectangle227:setXradius(8);
    obj.rectangle227:setYradius(8);
    ...
    obj.boxNadaSelecionado:setParent(obj.layout125);
    ...
    obj.rectangle229:setParent(obj.boxNadaSelecionado);
    obj.rectangle229:setAlign("client");
    obj.rectangle229:setColor("Gainsboro");
    obj.rectangle229:setXradius(6);
    obj.rectangle229:setYradius(6);
    obj.rectangle229:setName("rectangle229");

    obj.label244 = GUI.fromHandle(_obj_newObject("label"));
    obj.label244:setParent(obj.boxNadaSelecionado);
    ...
    obj.label244:setText("Selecione um item em Ataque, Danos ou Magias para editar.");
    ...
    obj.dsDetalhesDoItem:setParent(obj.layout125);
    ...
    obj.label245:setParent(obj.dsDetalhesDoItem);
    ...
    obj.edit68:setParent(obj.dsDetalhesDoItem);
    ...
    obj.label246:setParent(obj.dsDetalhesDoItem);
    obj.label246:setAlign("top");
    obj.label246:setHeight(18);
    lfm_setPropAsString(obj.label246, "fontStyle", "bold");
    obj.label246:setFontColor("Black");
    obj.label246:setText("Rolagem (Ataque/Dano/etc)");
    ...
    obj.label247:setParent(obj.dsDetalhesDoItem);
    obj.label247:setAlign("top");
    obj.label247:setHeight(18);
    lfm_setPropAsString(obj.label247, "fontStyle", "bold");
    obj.label247:setFontColor("Black");
    obj.label247:setText("Descrição");
    ...
    obj.dataLink7:setParent(obj.Tormenta06);
    obj.dataLink7:setFields({'__recalc06','campoDosItensAtaque','campoDosItensDanos','campoDosItensMagias'});
...
-- === Responsividade (Firecast 8.13 / SDK 3.7) ===
    ...
    obj._e_event0 = obj.Tormenta01:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain01, self.lytCanvas01);
        end);
    ...
    obj._e_event2 = obj.Tormenta01:addEventListener("onNodeReady",
        function ()
            TRPG_scheduleScale(self.sbMain01, self.lytCanvas01); desCalculos(); recalcAll();
        end);
    ...
    obj._e_event21 = obj.calculos:addEventListener("onClick",
        function (event)
    ...
    obj._e_event24 = obj.Tormenta02:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain02, self.lytCanvas02);
        end);

    obj._e_event25 = obj.Tormenta02:addEventListener("onResize",
        function ()
            TRPG_scheduleScale(self.sbMain02, self.lytCanvas02);
        end);

    obj._e_event26 = obj.Tormenta02:addEventListener("onNodeReady",
        function ()
        ...
        function (event)
            local sh = sheet or self.sheet;
            						if not (sh.cbxadestrar == true) then
            							 showMessage("Essa é uma pericia que precisa ser treinada para poder rolar.");
            							return;
            						end;
    ...
    obj._e_event40 = obj.button33:addEventListener("onClick",
        function (event)
            local sh = sheet or self.sheet;
            							...
            							if extra ~= "" then nome = nome .. " - " .. extra; end;
            							if not (sh.cbxconhecimento1 == true) then
            								 showMessage("Essa é uma pericia que precisa ser treinada para poder rolar.");
            								return;
            							end;
    ...
    obj._e_event42 = obj.button35:addEventListener("onClick",
        function (event)
            local sh = sheet or self.sheet;
            							...
            							if extra ~= "" then nome = nome .. " - " .. extra; end;
            							if not (sh.cbxconhecimento2 == true) then
            								 showMessage("Essa é uma pericia que precisa ser treinada para poder rolar.");
            								return;
            							end;
    ...
    obj._e_event63 = obj.button56:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_oinformacao", "CAR");
        end);

    obj._e_event64 = obj.button57:addEventListener("onClick",
        function (event)
            TRPG_rollValue(sheet or self.sheet, (sheet or self.sheet).totaloinformacao, "Obter Informação");
        end);

    obj._e_event65 = obj.button58:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_oficio1", "INT");
        end);

    obj._e_event66 = obj.button59:addEventListener("onClick",
        function (event)
            local sh = sheet or self.sheet;
            							local nome = "Ofício";
    ...
    obj._e_event67 = obj.button60:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_oficio2", "INT");
        end);

    obj._e_event68 = obj.button61:addEventListener("onClick",
        function (event)
            local sh = sheet or self.sheet;
            							local nome = "Ofício";
    ...
    obj._e_event69 = obj.button62:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_meditacao", "SAB");
        end);

    obj._e_event70 = obj.button63:addEventListener("onClick",
        function (event)
            local sh = sheet or self.sheet;
    ...
    obj._e_event71 = obj.button64:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_percepcao", "SAB");
        end);

    obj._e_event72 = obj.button65:addEventListener("onClick",
        function (event)
            TRPG_rollValue(sheet or self.sheet, (sheet or self.sheet).totalpercepcao, "Percepção");
        end);

    obj._e_event73 = obj.button66:addEventListener("onClick",
        function (event)
            TRPG_chooseHab(sheet or self.sheet, "hab_sobrevivencia", "SAB");
        end);

    obj._e_event74 = obj.button67:addEventListener("onClick",
        function (event)
            TRPG_rollValue(sheet or self.sheet, (sheet or self.sheet).totalsobrevivencia, "Sobrevivência");
        end);

    obj._e_event75 = obj.dataLink2:addEventListener("onChange",
        function (field, oldValue, newValue)
            onDataLinkChange();
        end);

    obj._e_event76 = obj.Tormenta03:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain03, self.lytCanvas03);
        end);

    obj._e_event77 = obj.Tormenta03:addEventListener("onResize",
        function ()
            TRPG_scheduleScale(self.sbMain03, self.lytCanvas03);
        end);

    obj._e_event78 = obj.Tormenta03:addEventListener("onNodeReady",
        function ()
    ...
    obj._e_event79 = obj.rcArmaCloseArea:addEventListener("onClick",
        function (event)
            TRPG_armaClose(self, sheet or self.sheet);
        end);

    obj._e_event80 = obj.button68:addEventListener("onClick",
        function (event)
            TRPG_addArma(self, sheet or self.sheet);
        end);

    obj._e_event81 = obj.rclArmas:addEventListener("onSelect",
        function ()
            TRPG_armaOnSelect(self, sheet or self.sheet);
        end);

    obj._e_event82 = obj.button69:addEventListener("onClick",
        function (event)
            TRPG_armaClose(self, sheet or self.sheet);
        end);

    obj._e_event83 = obj.dataLink3:addEventListener("onChange",
        function (field, oldValue, newValue)
            TRPG_armaUpdateTitulo(self);
        end);

    obj._e_event84 = obj.rcDefCloseArea:addEventListener("onClick",
        function (event)
            TRPG_defClose(self, sheet or self.sheet);
        end);

    obj._e_event85 = obj.button70:addEventListener("onClick",
        function (event)
            TRPG_addDefesa(self, sheet or self.sheet, "Armadura");
        end);

    obj._e_event86 = obj.button71:addEventListener("onClick",
        function (event)
            TRPG_addDefesa(self, sheet or self.sheet, "Escudo");
        end);

    obj._e_event87 = obj.button72:addEventListener("onClick",
        function (event)
            TRPG_addDefesa(self, sheet or self.sheet, "Outros");
        end);

    obj._e_event88 = obj.rclDefesas:addEventListener("onSelect",
        function ()
            TRPG_defOnSelect(self, sheet or self.sheet);
        end);

    obj._e_event89 = obj.button73:addEventListener("onClick",
        function (event)
            TRPG_defClose(self, sheet or self.sheet);
        end);

    obj._e_event90 = obj.dataLink4:addEventListener("onChange",
        function (field, oldValue, newValue)
            TRPG_defUpdateTitulo(self);
        end);

    obj._e_event91 = obj.rcEquipCloseArea:addEventListener("onClick",
        function (event)
    ...
    obj._e_event93 = obj.rclEquip:addEventListener("onSelect",
        function ()
            TRPG_equipOnSelect(self, sheet or self.sheet);
        end);

    obj._e_event94 = obj.button75:addEventListener("onClick",
        function (event)
            TRPG_equipClose(self, sheet or self.sheet);
        end);

    obj._e_event95 = obj.dataLink5:addEventListener("onChange",
        function (field, oldValue, newValue)
            TRPG_equipUpdateTitulo(self);
        end);

    obj._e_event96 = obj.dataLink6:addEventListener("onChange",
        function (field, oldValue, newValue)
            TRPG_recalcPenDefesas(sheet or self.sheet); TRPG_calcCarga03(self, sheet or self.sheet);
        end);

    obj._e_event97 = obj.Tormenta04:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain04, self.lytCanvas04);
        end);

    obj._e_event98 = obj.Tormenta04:addEventListener("onResize",
        function ()
            TRPG_scheduleScale(self.sbMain04, self.lytCanvas04);
        end);

    obj._e_event99 = obj.Tormenta04:addEventListener("onNodeReady",
        function ()
            TRPG_scheduleScale(self.sbMain04, self.lytCanvas04);
        end);

    obj._e_event100 = obj.Tormenta05:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain05, self.lytCanvas05);
        end);

    obj._e_event101 = obj.Tormenta05:addEventListener("onResize",
        function ()
            TRPG_scheduleScale(self.sbMain05, self.lytCanvas05);
        end);

    obj._e_event102 = obj.Tormenta05:addEventListener("onNodeReady",
        function ()
            TRPG_scheduleScale(self.sbMain05, self.lytCanvas05);
        end);

    obj._e_event103 = obj.Tormenta06:addEventListener("onShow",
        function ()
            TRPG_scheduleScale(self.sbMain06, self.lytCanvas06);
        end);

    obj._e_event104 = obj.Tormenta06:addEventListener("onResize",
        function ()
            TRPG_scheduleScale(self.sbMain06, self.lytCanvas06);
        end);

    obj._e_event105 = obj.Tormenta06:addEventListener("onNodeReady",
        function ()
            TRPG_scheduleScale(self.sbMain06, self.lytCanvas06);
        end);

    obj._e_event106 = obj.button76:addEventListener("onClick",
        function (event)
    ...
    obj._e_event107 = obj.button77:addEventListener("onClick",
        function (event)
    ...
    obj._e_event108 = obj.button78:addEventListener("onClick",
        function (event)
    ...
    obj._e_event109 = obj.rclAtaque:addEventListener("onSelect",
        function ()
    ...
    obj._e_event110 = obj.rclDanos:addEventListener("onSelect",
        function ()
    ...
    obj._e_event111 = obj.rclMagias:addEventListener("onSelect",
        function ()
            self.rclAtaque.selectedNode = nil;
            										self.rclDanos.selectedNode = nil;
    ...
    obj._e_event112 = obj.dataLink7:addEventListener("onChange",
        function (field, oldValue, newValue)
        end);
    ...
    function obj:destroy() 
        ...
        if self.lytCanvas03 ~= nil then self.lytCanvas03:destroy(); self.lytCanvas03 = nil; end;
        ...
        if self.boxDefDetalhes ~= nil then self.boxDefDetalhes:destroy(); self.boxDefDetalhes = nil; end;
        ...
        if self.lblArmaTitulo ~= nil then self.lblArmaTitulo:destroy(); self.lblArmaTitulo = nil; end;
        if self.Tormenta06 ~= nil then self.Tormenta06:destroy(); self.Tormenta06 = nil; end;
        if self.lytCanvas05 ~= nil then self.lytCanvas05:destroy(); self.lytCanvas05 = nil; end;
        ...
        if self.lytCanvas01 ~= nil then self.lytCanvas01:destroy(); self.lytCanvas01 = nil; end;
        ...
        if self.lblDefTitulo ~= nil then self.lblDefTitulo:destroy(); self.lblDefTitulo = nil; end;
        ...
        if self.boxArmaDetalhes ~= nil then self.boxArmaDetalhes:destroy(); self.boxArmaDetalhes = nil; end;
        ...
        if self.lytCanvas02 ~= nil then self.lytCanvas02:destroy(); self.lytCanvas02 = nil; end;
        ...
        if self.rcArmaCloseArea ~= nil then self.rcArmaCloseArea:destroy(); self.rcArmaCloseArea = nil; end;
...
function newTormentafrm()
    ...
    __o_Utils.tryFinally(
      function()
        retObj = constructNew_Tormentafrm();
      end,
      function()
...
local _Tormentafrm = {
    ...
    cacheMode = "time", 
    title = "Ficha Tormenta RPG (Firecast 8.13)", 
    description=""};

Tormentafrm = _Tormentafrm;
Firecast.registrarForm(_Tormentafrm);
Firecast.registrarDataType(_Tormentafrm);
